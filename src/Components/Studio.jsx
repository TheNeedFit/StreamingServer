...
function Studio() {
  ...
  return (
    <>
      <Navbar2 />
      <LeftPanel2 />
      <div className={theme ? "studio" : "studio studio-light"} style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div
          ...
          style={
            isChannel === true
              ? { display: "flex" ,    height:"4rem" , width:"19rem" ,  position:"absolute" , top:"50%" , right:"35%"  , background: "#1877F2" }
              : { display: "none"  }
          }
        >
          ...
          <AddIcon
            className=""
            fontSize="large"
            style={{ color: "#FFFFFF"  , position:"absolute" , left:"30%"}}
          />
          <p  style={{color:"#FFFFFF"  , position:"absolute" , left:"40%" , fontWeight:"bold"}}  className={theme ? "" : "text-light-mode"}>CREATE</p>
        </div>
